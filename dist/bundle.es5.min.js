...
function R(a){var b=this;this.a=this.u=this.o=0;this.f=[];this.i=a;this.context={D:function(a,c,e){return S(b,N(a,c),e)},F:function(a){return S(b,!1,a)},G:function(a,c,e){return S(b,!N(a,c),e)},H:function(a){return S(b,!0,a)},test:function(a,c,e){return b.test(a,c,e)}}}
R.prototype.test=function(a,b,d){var c=this;this.c&&!this.c.test(a)||this.b&&this.b.test(a)||this.f.push(function(){var e;return H(new G(new C(function(f){if(1==f.a)return c.i&&c.i.label(a),f.g=2,d&&"number"===typeof d.timeout?z(f,Promise.race([b(c.context),new Promise(function(a,b){setTimeout(function(){return b(Error("Timeout"))},d.timeout)})])):z(f,b(c.context));if(2!=f.a)return A(f);e=B(f);++c.u;c.i&&c.i.error(e);f.a=0})))})};
function S(a,b,d){b&&++a.o;a.i&&a.i.test({description:d?d:"",id:++a.a,o:b})}var T=new R(new O);function U(a,b){T.test(a,b)}"undefined"!==typeof window&&(window.Typtap=R,window.Tap=O,window.test=U);}).call(this);
